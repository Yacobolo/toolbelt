...
func TestRoutesRenderMultiRepoPagesAndRefreshRedirect(t *testing.T) {
	...
	assertPageContains(t, server.URL+"/repos/ai-platform/files/internal%2Fservices%2Fusecase.go", "governance-code-viewer")
	assertPageContains(t, server.URL+"/repos/ai-platform/files/internal%2Fservices%2Fusecase.go", "Open package")
	assertPageContains(t, server.URL+"/repos/ai-platform/packages", "governance-graph-view")
	assertPageContains(t, server.URL+"/repos/ai-platform/packages/example.com%2Frepo%2Finternal%2Fui", "Neighborhood")
