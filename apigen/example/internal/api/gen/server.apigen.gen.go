...
var genOperationContracts = map[string]GenOperationContract{
	"listTodos":    {OperationID: "listTodos", Method: "GET", Path: "/todos", Tags: []string{"Todos"}, DocumentedStatusCodes: []int{200, 400, 401, 403, 404, 409, 429, 500, 502}, RequestBodyRequired: false, AuthzMode: "", Protected: false, Manual: false, Extensions: map[string]any{"x-agent": map[string]any{"enabled": true, "name": "list_todos", "risk": "read", "tags": []any{"todos", "read"}}}},
