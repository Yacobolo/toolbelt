...
- TypeScript only handles generic URL/history helpers
...
- `src/main.ts`: single-file TypeScript implementation for the URL/history helpers used by the Datastar page
